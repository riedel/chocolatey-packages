...
$silentArgs = '/NORESTART /VERYSILENT /SUPPRESSMSGBOXES' # "/s /S /q /Q /quiet /silent /SILENT /VERYSILENT" # try any of these to get the silent installer #msi is always /quiet
